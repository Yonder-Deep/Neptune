 ...
 * For HolyBro Telemetry Radio:
     ...
     on Pi: sudo pppd /dev/ttyUSB0 57600 lock local noauth
 192.168.100.11:192.168.100.10 on base: sudo pppd /dev/ttyUSB0 57600 lock local
 noauth nodetach 192.168.100.10:192.168.100.11
...
public:
   ...
   * Returns false if the client disconnected (caller should call accept_client
   * again).
   */
