...
public:
  /**
   * @brief sets the motor to run at speed until this or another method is
   * called
   * @param speed A value between -1.0 and 1.0, with -1.0 being max reverse
   * thrust, 0.0 being still, and 1.0 being max forward thrust
