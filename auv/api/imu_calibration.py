...
def main():
    ...
    global_vars.mag_offset_vector = (offset_x, offset_y, offset_z)
    print(
    ...
    global_vars.gyro_offset_vector = (offset_x, offset_y, offset_z)
    print(
    ...
    print("")
    print("------------------------------------------------------------------------")
    print("Final Magnetometer Calibration Values: ", global_vars.mag_offset_vector)
    print("Final Gyro Calibration Values: ", global_vars.gyro_offset_vector)
