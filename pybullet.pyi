...
def loadURDF(fileName:str, basePosition:list[float]=[], baseOrientation:list[float]=[], useMaximalCoordinates:int=0, useFixedBase:bool=False, flags:int=0, globalScaling:float=1.0, physicsClientId:int=0): # real signature unknown; restored from __doc__
    """
